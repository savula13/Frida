...
public class RobotMap {
    ...
    public static WPI_TalonSRX drivetrainSpeedController1;
    public static WPI_TalonSRX drivetrainSpeedController2;
    public static SpeedControllerGroup drivetrainSpeedControllerGroupL;
    public static WPI_TalonSRX drivetrainSpeedController3;
    public static WPI_TalonSRX drivetrainSpeedController4;
    ...
    public static SpeedControllerGroup grabberGroup;
    
    public static SpeedController grabber1;
    public static SpeedController grabber2;
    ...
    public static void init() {
    	...
    	drivetrainSpeedController1 = new WPI_TalonSRX(5);
        ...
        drivetrainSpeedController2 = new WPI_TalonSRX(6);
       ...
       // LiveWindow.addActuator("Drivetrain", "Speed Controller Group L", drivetrainSpeedControllerGroupL);
        ...
        drivetrainSpeedController3 = new WPI_TalonSRX(7);
       // LiveWindow.addActuator("Drivetrain", "Speed Controller 3", (Talon) drivetrainSpeedController3);
        ...
        drivetrainSpeedController4 = new WPI_TalonSRX(8);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        grabber1 = new Talon(1);
        grabber2 = new Talon(2);
        lift = new Talon(3);
        climber = new Talon(4);
        grabberGroup = new SpeedControllerGroup(grabber1,grabber2);
